  ...
  return (
    ...
    <div className='flex lg:flex-row flex-col'> 
     ...
     <div className='lg:block sm:hidden w-full'>
        <img src={allPets?.image} className="lg:w-103 w-full border border-gray-600 h-80"/>  
     ...
     <div className='sm:ml-4 we:ml-2 lg:pl-16 lg:pt-0 pt-5'>
       ...
       <div className='mt-2 text-slate-500 font-semibold text-sm'>YOU CAN GET THE DESIRED INFORMATION ABOUT TOMY VIA EMAIL OR BY CALLING AT THE CONTACT NUMBER PROVIDED 
        BY TOMY'S CURRENT OWNER.
       </div>
