  ...
  return (
    <div className="2xl:pl-24 xl:pl-20 lg:pl-16 md:pl-6 sm:pl-4 pl-2 2xl:pr-24 xl:pr-20 lg:pr-16 md:pr-6 sm:pr-4 pr-2 w-full wq:pt-6 pt-4 wq:pb-6 pb-4">
      ...
      <div className="sm:ml-2 mr-1 mt-2">
        <div className='w-full h-10 mr-3 flex cursor-pointer flex-row justify-center shadow-lg rounded bg-gradient-to-r from-sky-600 to-sky-400'>
        <button onClick={getPets2} className='text-sm rounded text-white font-semibold'>SEARCH</button>
        </div>
      </div>
      </div>
