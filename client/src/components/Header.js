...
function Header(props) {
  ...
  return (
    ...
    <div className={`xl:pl-24 lg:pl-16 md:pl-6 xl:pr-24 lg:pr-16 md:pr-6 flex flex-row ${props?.yes === "no" ? "md:bg-purple-800":"md:bg-slate-200"} w-full bg-purple-800`}>
      ...
      <div className={`w-1/4 ${props?.yes === "no" ? "md:text-white":"md:text-purple-800"} sm:block hidden text-white pl-4 pt-2 pb-2 md:text-xl text-lg font-sans`} id='title'>PETNATION</div>
